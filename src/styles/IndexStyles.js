...
const GenericPara = styled.p`
	...
	font-size: ${props => (props.lessSize ? "2rem": "2.5rem")};
...
const GenereicParaAbout = styled.p`
	...
	text-align: center;
	letter-spacing: ${props => (props.lessSpacing ? "0.075em":"0.225em")};
	font-size: ${props => (props.lessSize ? "2rem":"3rem")};
...
export { Banner, TextWrapper, MoreText, SectionTwo, SectionThree, 
	FlexBoxIndex, GenericPara, GenericH2,GenericH3, SectionFour, FormFive, Footer,
	Header, Works, GenereicParaAbout}
